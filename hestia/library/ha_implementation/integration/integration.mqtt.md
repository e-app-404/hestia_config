...
source: https://github.com/home-assistant/home-assistant.io/blob/current/source/_integrations/mqtt.markdown
---
...
> Important: If you experience an error message like `Failed to connect due to exception: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed`, then turn on `Advanced options` and set Broker certificate validation to `Auto`.
...
Discovery id: `0AFFD2 bla` _(`0AFFD2`from discovery topic, `bla`: The key under `cmps` in the discovery payload)_
