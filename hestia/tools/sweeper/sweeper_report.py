            ...
            with open(log_file_path) as f:
                ...
                if content.startswith("---\n"):
                    ...
                    if end_marker != -1:
                        ...
                        return {"frontmatter": frontmatter, "data": data}
        ...
        report = {
            ...
            "executive_summary": {
                ...
                "total_files_processed": (
                    summary.files_renamed + summary.files_cleaned + summary.files_vault_managed
                ),
...
def main():
    ...
    parser.add_argument(
        "--shared-log", required=True, help="Path to shared log file from sweeper pipeline"
    )
    parser.add_argument("--output", help="Custom output path for comprehensive report")
    parser.add_argument(
        "--update-index", action="store_true", help="Update the report index with new report entry"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
