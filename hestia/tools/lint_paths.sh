...
if command -v rg >/dev/null 2>&1; then
  ...
  MATCHES=$(git ls-files | grep -vE '\.md$|^ADR/deprecated/|^docs/history/|^library/docs/ADR-imports/|^hestia/workspace/|^hestia/tools/|^hestia/config/|^hestia/library/|^hestia/config/index/|^\.githooks/|^\.env|^hestia/config/system/maintenance_log\.conf$|^hestia/config/system/user\.toml$|^\.git/|^\.venv/|node_modules/|\.png$|\.jpg$|\.svg$|\.ico$' \
